...
public class SpriteSet {
     ...
     * 
     * @param fileName name of the XML file containing the sprite set
     *            description
     * 
     */
    public void loadSpritesFrom(String fileName) throws PurpleException {
        ...
        Optional<Element> propertiesElementsOptional = XMLTools
                .getUniqueChildElement(spriteSetElement, "properties");
        ...
        // Loads sprites
        Optional<Element> spriteElementsOptional = XMLTools.getUniqueChildElement(spriteSetElement,
                "sprites");
        spritesFromElement(spriteElementsOptional.orElseThrow(() -> new PurpleException(
                "Missing 'sprites' element in the XML sprite set descriptor")));
    ...
    private Sprite spriteFromElement(Element spriteElement) {
        return new Sprite(spriteElement.getAttribute("name"),
                Integer.parseInt(spriteElement.getAttribute("ox")),
