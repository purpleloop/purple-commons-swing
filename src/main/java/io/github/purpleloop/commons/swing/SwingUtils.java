...
public final class SwingUtils {
     ...
     */
    public static JCheckBoxMenuItem addCheckBoxMenuItem(Action action, JMenu parentMenu,
            boolean selected) {
     ...
     */
    public static void displayMessage(Component parentComponent, UiMessageType messageType,
        ...
        } else if (messageType == UiMessageType.WARN) {

            JOptionPane.showMessageDialog(parentComponent, message, "Warning message",
                    JOptionPane.WARNING_MESSAGE);

        } else if (messageType == UiMessageType.INFO) {
