...
public final class SwingUtils {
	 ...
	 * @return the button
	 */
	public static JButton createButton(String caption, String cmd, Container cont, ActionListener list,
			boolean enabled) {
	 ...
	 * @return the button
	 */
	public static JButton createButton(String caption, String cmd, Container cont, Object constraints,
	 ...
	 */
	public static JTextField addTextField(int columns, String initialText, Container cont, Object constraints) {
	 ...
	 */
	public static JComboBox<String> createComboBox(String[] items, String cmd, Container cont, ActionListener list,
			Object constraints) {
	 ...
	 * @return the checkBox
	 */
	public static JCheckBox createCheckBox(String text, String actionName, Container cont, ActionListener aListener,
			boolean selected, Object constraints) {
	 ...
	 */
	public static JSlider createSlider(Container owner, int minimumValue, int maximumValue, int currentValue,
			int ticksSpacing, boolean paintTicks) {
	 ...
	 * @return menu item
	 */
	public static JMenuItem addMenuItem(String label, String command, ActionListener listener, JMenu parentMenu) {
	 ...
	 * Creates a menu item.
	 * 
	 * @param action     Action to associate with the menuItem
	 * @param parentMenu parent menu
	 * @return menu item
	 */
	public static JMenuItem addMenuItem(Action action, JMenu parentMenu) {
	 ...
	 * @return menu item
	 */
	public static JCheckBoxMenuItem addCheckBoxMenuItem(String label, String command, ActionListener listener,
			JMenu parentMenu, boolean selected) {
	 ...
	 * Creates a checkBox menu item.
	 * 
	 * @param action     Action to associate with the checkBoxMenuItem
	 * @param parentMenu parent menu
	 * @param selected   true if the menu item is selected, false otherwise
	 * @return check box menu item
	 */
	public static JCheckBoxMenuItem addCheckBoxMenuItem(Action action, JMenu parentMenu, boolean selected) {
		JCheckBoxMenuItem checkBoxMenuItem = new JCheckBoxMenuItem(action);
		checkBoxMenuItem.setSelected(selected);
		parentMenu.add(checkBoxMenuItem);
	 ...
	 */
	public static void displayMessage(Component parentComponent, MessageType messageType, String message,
			JTextArea console) {
		if (messageType == MessageType.ERROR) {

			Toolkit.getDefaultToolkit().beep();
			JOptionPane.showMessageDialog(parentComponent, message, "Error message", JOptionPane.ERROR_MESSAGE);
		} else if (messageType == MessageType.WARN) {

			JOptionPane.showMessageDialog(parentComponent, message, "Warning message", JOptionPane.WARNING_MESSAGE);

		} else if (messageType == MessageType.INFO) {

			JOptionPane.showMessageDialog(parentComponent, message, "Message", JOptionPane.INFORMATION_MESSAGE);
		} else {
